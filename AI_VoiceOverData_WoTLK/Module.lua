...
AI_VoiceOverData_WoTLK = {}

function AI_VoiceOverData_WoTLK:GetSoundPath(fileName, event)
    setfenv(1, VoiceOver)
...
VoiceOver.DataModules:Register("AI_VoiceOverData_WoTLK", AI_VoiceOverData_WoTLK)
